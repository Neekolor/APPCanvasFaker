package dev.nikko.appcanvasfaker.ui.theme
...
import dev.nikko.appcanvasfaker.data.repository.SettingsRepository
import dev.nikko.appcanvasfaker.data.repository.SettingsRepositoryImpl
...
fun AppCanvasFakerTheme(
    ...
    when (uiMode) {
        UiMode.Miuix -> AppCanvasFakerMiuixTheme(
            appSettings = appSettings,
            content = content
        )

        UiMode.Material -> AppCanvasFakerMaterialTheme(
            appSettings = appSettings,
            content = content
        )
    }
