package dev.neekolor.appcanvasfaker.ui.component.material
...
fun SearchAppBar(
    ...
    // 细粒度派生：文本状态只在真正用到 currentQuery 的最小作用域内被读取，
    // 避免每敲一键导致整个 SearchAppBar（含顶栏）全量重组
    val currentQuery by remember(textFieldState) { derivedStateOf { textFieldState.text.toString() } }
